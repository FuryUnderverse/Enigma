...
# Seeds IPs
ENIGMA_SEEDS_DEFAULT_IPS="3.88.76.0,54.88.212.224"
# Statysync servers default IPs
ENIGMA_STATESYNC_SERVERS_DEFAULT_IPS="3.219.52.168,44.206.144.197"
...
#copy genesis file
cp -r ../../genesis/testnet/genesis-testnet-1.json $ENIGMA_HOME_CONFIG/genesis.json
