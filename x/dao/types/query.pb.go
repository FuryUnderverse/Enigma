...
// source: enigma/dao/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "enigma.dao.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "enigma.dao.v1.QueryParamsResponse")
	proto.RegisterType((*QueryTreasuryRequest)(nil), "enigma.dao.v1.QueryTreasuryRequest")
	proto.RegisterType((*QueryTreasuryResponse)(nil), "enigma.dao.v1.QueryTreasuryResponse")
}

func init() { proto.RegisterFile("enigma/dao/v1/query.proto", fileDescriptor_1d6940140b83f0f7) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.dao.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Treasury(ctx context.Context, in *QueryTreasuryRequest, opts ...grpc.CallOption) (*QueryTreasuryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.dao.v1.Query/Treasury", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.dao.v1.Query/Params",
	}
...
func _Query_Treasury_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.dao.v1.Query/Treasury",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "enigma.dao.v1.Query",
	...
	Metadata: "enigma/dao/v1/query.proto",
}
