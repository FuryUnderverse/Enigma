...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"furyunderverse", "dao", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Treasury_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"furyunderverse", "dao", "v1", "treasury"}, "", runtime.AssumeColonVerbOpt(false)))
)
